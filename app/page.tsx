    ...
    <main className="max-w-3xl mx-auto px-2 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-4 sm:space-y-8">
      {Object.entries(matchesByDate).map(([date, matches]) => (
        <section key={date} aria-labelledby={`date-heading-${date}`}>
          <div className="flex items-center gap-4 mb-3 sm:mb-6 sticky top-[130px] z-30 bg-zinc-50/90 dark:bg-zinc-950/90 backdrop-blur-md py-1.5 sm:py-2 border-y border-zinc-200 dark:border-zinc-800">
            <h2
